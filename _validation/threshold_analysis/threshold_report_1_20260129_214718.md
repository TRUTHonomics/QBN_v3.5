...
**Asset ID:** 1
**Lookback:** 365 dagen
**Analyse Timestamp:** 2026-01-29T21:47:11.320800
...
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.8020 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0109 |
| CART_ALL_LEADING | 0.05 | 0.15 | CV_Accuracy=0.9180 |
| CART_ALL_COINCIDENT | 0.17 | 0.15 | CV_Accuracy=0.9180 |
| CART_ALL_CONFIRMING | 0.14 | 0.15 | CV_Accuracy=0.9180 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.4637 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0088 |
| CART_ALL_LEADING | 0.03 | 0.15 | CV_Accuracy=0.7583 |
| CART_ALL_COINCIDENT | 0.14 | 0.15 | CV_Accuracy=0.7583 |
| CART_ALL_CONFIRMING | 0.04 | 0.15 | CV_Accuracy=0.7583 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.5612 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0323 |
| CART_ALL_LEADING | 0.03 | 0.15 | CV_Accuracy=0.5155 |
| CART_ALL_COINCIDENT | 0.05 | 0.15 | CV_Accuracy=0.5155 |
| CART_ALL_CONFIRMING | 0.07 | 0.15 | CV_Accuracy=0.5155 |
