...
**Asset ID:** 1
**Lookback:** 365 dagen
**Analyse Timestamp:** 2026-01-13T20:01:23.240195
...
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.6630 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.7767 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0159 |
| CART_ALL_LEADING | 0.07 | 0.5 | CV_Accuracy=0.9763 |
| CART_ALL_COINCIDENT | 0.12 | 0.5 | CV_Accuracy=0.9763 |
| CART_ALL_CONFIRMING | 0.09 | 0.5 | CV_Accuracy=0.9763 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.6074 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0176 |
| CART_ALL_LEADING | 0.03 | 0.5 | CV_Accuracy=0.5034 |
| CART_ALL_COINCIDENT | 0.04 | 0.5 | CV_Accuracy=0.5034 |
| CART_ALL_CONFIRMING | 0.04 | 0.5 | CV_Accuracy=0.5034 |
...
⚠️ Let op: Methoden geven verschillende neutral_band waarden (spread: 0.07). Overweeg verdere analyse.

### 1d Horizon

**Aanbevolen configuratie:**
- COMPOSITE_NEUTRAL_BAND: 0.04
- COMPOSITE_STRONG_THRESHOLD: 0.41
