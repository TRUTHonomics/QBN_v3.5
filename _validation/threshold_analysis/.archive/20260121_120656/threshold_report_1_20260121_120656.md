...
**Asset ID:** 1
**Lookback:** 365 dagen
**Analyse Timestamp:** 2026-01-21T12:06:50.077445
...
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.5456 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.6243 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0185 |
| CART_ALL_LEADING | 0.03 | 0.5 | CV_Accuracy=0.7493 |
| CART_ALL_COINCIDENT | 0.17 | 0.5 | CV_Accuracy=0.7493 |
| CART_ALL_CONFIRMING | 0.04 | 0.5 | CV_Accuracy=0.7493 |
