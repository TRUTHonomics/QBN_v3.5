...
**Asset ID:** 1
**Lookback:** 365 dagen
**Analyse Timestamp:** 2026-01-17T20:00:33.163718
...
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.7214 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.8289 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0077 |
| CART_ALL_LEADING | 0.15 | 0.5 | CV_Accuracy=0.9755 |
| CART_ALL_COINCIDENT | 0.14 | 0.5 | CV_Accuracy=0.9755 |
| CART_ALL_CONFIRMING | 0.14 | 0.5 | CV_Accuracy=0.9755 |
