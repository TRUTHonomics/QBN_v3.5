...
**Asset ID:** 1
**Lookback:** 365 dagen
**Analyse Timestamp:** 2026-01-15T05:40:17.228570
...
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.7199 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.7792 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0158 |
| CART_ALL_LEADING | 0.07 | 0.5 | CV_Accuracy=0.9762 |
| CART_ALL_COINCIDENT | 0.06 | 0.5 | CV_Accuracy=0.9762 |
| CART_ALL_CONFIRMING | 0.15 | 0.5 | CV_Accuracy=0.9762 |
