...
**Asset ID:** 1
**Lookback:** 365 dagen
**Analyse Timestamp:** 2026-01-14T15:51:42.617438
...
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.6644 |
...
| Methode | NEUTRAL_BAND | STRONG_THRESHOLD | Score |
|---------|--------------|------------------|-------|
| LOGREG_ALL | None | None | AUC=0.7869 |
| MI_LEADING | 0.05 | 0.15 | MI=0.0142 |
| CART_ALL_LEADING | 0.07 | 0.5 | CV_Accuracy=0.9763 |
| CART_ALL_COINCIDENT | 0.06 | 0.5 | CV_Accuracy=0.9763 |
| CART_ALL_CONFIRMING | 0.15 | 0.5 | CV_Accuracy=0.9763 |
