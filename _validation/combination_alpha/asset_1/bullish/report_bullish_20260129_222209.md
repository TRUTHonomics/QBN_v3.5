...
**Asset ID:** 1  
**Target Type:** Bullish  
**Analysis Date:** 2026-01-29 22:22:08 UTC  
...
**Horizon:** 1h  
**Odds Ratio:** 1.78 (95% CI: 1.61 - 1.96)  
**Sensitivity:** 33.5%  
**Specificity:** 77.9%  
**Sample Size:** 6938.9481201171875
...
## Golden Rules (1 combinations)

These combinations show strong, statistically significant predictive power.

| Horizon | Combination | OR | 95% CI | Sens | Spec | MCC | n |
|---------|-------------|----:|--------|------|------|-----|---|
| 1h | `neutral|bullish|bullish` | 1.78 | 1.61-1.96 | 33.5% | 77.9% | 0.068 | 6938.9481201171875 |


## Promising Combinations (4 combinations)

These combinations show potential but need further validation.

| Horizon | Combination | OR | 95% CI | p-adj | n |
|---------|-------------|----:|--------|-------|---|
| 1d | `bullish|neutral|bullish` | 2.19 | 1.57-3.07 | 0.0000 | 147.6861114501953 |
| 4h | `neutral|bullish|bullish` | 1.34 | 1.25-1.44 | 0.0000 | 7648.0855712890625 |
| 1d | `bullish|bullish|bullish` | 1.05 | 0.87-1.27 | 0.6826 | 429.4018096923828 |
| 1d | `bullish|bullish|neutral` | 1.02 | 0.70-1.49 | 0.9222 | 105.46111297607422 |
...
1. **Implement Golden Rules**: 1 combinations show strong predictive power
